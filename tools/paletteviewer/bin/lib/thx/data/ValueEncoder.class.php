...
class thx_data_ValueEncoder {
	public function __construct($handler) {
		...
		$GLOBALS['%s']->push("thx.data.ValueEncoder::new");
	...
	public function encode($o) {
		$GLOBALS['%s']->push("thx.data.ValueEncoder::encode");
		$»spos = $GLOBALS['%s']->length;
		$this->handler->start();
		$this->encodeValue($o);
		$this->handler->end();
	...
	public function encodeValue($o) {
		$GLOBALS['%s']->push("thx.data.ValueEncoder::encodeValue");
		$»spos = $GLOBALS['%s']->length;
		$»t = (Type::typeof($o));
		switch($»t->index) {
		case 0:
	...
	public function encodeObject($o) {
		$GLOBALS['%s']->push("thx.data.ValueEncoder::encodeObject");
		$»spos = $GLOBALS['%s']->length;
	...
	public function encodeHash($o) {
		$GLOBALS['%s']->push("thx.data.ValueEncoder::encodeHash");
		$»spos = $GLOBALS['%s']->length;
		$this->handler->startObject();
	...
	public function encodeList($list) {
		$GLOBALS['%s']->push("thx.data.ValueEncoder::encodeList");
		$»spos = $GLOBALS['%s']->length;
	...
	public function encodeArray($a) {
		$GLOBALS['%s']->push("thx.data.ValueEncoder::encodeArray");
		$»spos = $GLOBALS['%s']->length;
		$this->handler->startArray();
		{
			$_g = 0;
