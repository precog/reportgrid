...
class DateTools {
	...
	static $WEEKDAYS;
	static $WEEKDAYS_ABBREV;
	static $MONTHS;
	static $MONTHS_ABBREV;
...
DateTools::$WEEKDAYS = new _hx_array(array("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"));
DateTools::$WEEKDAYS_ABBREV = new _hx_array(array("Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"));
DateTools::$MONTHS = new _hx_array(array("January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"));
DateTools::$MONTHS_ABBREV = new _hx_array(array("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"));
